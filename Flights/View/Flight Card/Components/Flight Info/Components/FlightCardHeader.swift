...
struct FlightCardHeader: View {
    
    @State private var statusIsShowing = true
    @State private var statusDescription = "ON TIME"
    ...
    var status: some View {
        Button(action: {
            ...
            Text(self.statusDescription)
                ...
                .background(statusDescription == "ON TIME" ? Color.green : Color.red)
                .cornerRadius(14)
        }
    }
